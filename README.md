...
- 远程重启/停止隧道
- 查看最近日志
- **自动刷新（5秒）**：页面每5秒自动刷新，确保显示最新状态

> **注意**：Web 监控需要 Python 环境。访问地址：`http://localhost:9090`
...
| 符号 | 说明 |
|------|------|
| `$HOME` | 用户主目录，脚本和配置文件的存放位置 |
| `~/.cloudflared/` | 配置和日志的存放目录 |
